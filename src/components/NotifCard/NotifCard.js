...
export const NotifCard = ({ valType, minVal, maxVal, FirstOperation, SecondOperation }) => {
    return (
        <div className="notifCardContainer cursor-pointer">
            ...
            <div className="acceptIcons">
                <Check fontSize="30px" className="icon text-green-600" />
                <Cross fontSize="20px" className="icon text-red-600" />
            </div>
        </div>
    )
}
